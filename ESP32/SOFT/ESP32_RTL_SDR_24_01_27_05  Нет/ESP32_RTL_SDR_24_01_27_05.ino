...
//extern void class_driver_mainask(void* arg);
...
static void action_open_dev(class_driver_main* driver_obj);
static void action_get_info(class_driver_main* driver_obj);
void action_get_dev_desc1(class_driver_main* driver_obj);
static void action_get_config_desc(class_driver_main* driver_obj);
static void action_get_str_desc(class_driver_main* driver_obj);
static void aciton_close_dev(class_driver_main* driver_obj);
void class_driver_mainask(void* arg);
...
static void client_event_cb(const usb_host_client_event_msg_t* event_msg, void* arg)
{
    class_driver_main* driver_obj = (class_driver_main*)arg;
    esp_err_t err;
...
void class_driver_mainask(void* arg)
{
    ...
    class_driver_main driver_obj = { 0 };
...
void setup()
{
  ...
  TaskHandle_t class_driver_mainask_hdl;
  ...
  xTaskCreatePinnedToCore(
    class_driver_mainask,
    "class",
    4096,
    (void*)signaling_sem,
    CLASS_TASK_PRIORITY,
    &class_driver_mainask_hdl,
    0);
