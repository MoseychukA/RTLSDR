...
void init_adsb_dev()
{
    adsbdev = (class_adsb_dev*)calloc(1, sizeof(class_adsb_dev)); //!!¬ыдел€ет блок пам€ти дл€ массива num элементов, каждый из которых size имеет длину в байт, и инициализирует все его биты равными нулю.
