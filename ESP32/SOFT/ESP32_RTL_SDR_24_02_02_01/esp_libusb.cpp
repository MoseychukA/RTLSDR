...
void init_adsb_dev()
{
    adsbdev = (class_adsb_dev*)calloc(1, sizeof(class_adsb_dev)); //!!Выделяет блок памяти для массива num элементов, каждый из которых size имеет длину в байт, и инициализирует все его биты равными нулю.
    adsbdev->is_adsb = true;
}

/*чтение массовой передачи*/
...
/* Настройка параметров для передачи данных ADSB */
...
/* Получение строки даннх виде ascii */
