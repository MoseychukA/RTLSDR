...
{
  class_driver_t_driver *driver_obj = (class_driver_t_driver *)arg;
  esp_err_t err;
...
static void action_open_dev(class_driver_t_driver *driver_obj)
{
...
static void action_get_info(class_driver_t_driver *driver_obj)
{
...
void action_get_dev_desc1(class_driver_t_driver *driver_obj)
{
  assert(driver_obj->dev_hdl != NULL);
...
static void action_get_config_desc(class_driver_t_driver *driver_obj)
{
  assert(driver_obj->dev_hdl != NULL);
...
static void action_get_str_desc(class_driver_t_driver *driver_obj)
{
  assert(driver_obj->dev_hdl != NULL);
  usb_device_info_t dev_info;
  ESP_ERROR_CHECK(usb_host_device_info(driver_obj->dev_hdl, &dev_info));
...
static void aciton_close_dev(class_driver_t_driver *driver_obj)
{
...
void class_driver_task(void *arg)
{
  ...
  class_driver_t_driver driver_obj = {0};
