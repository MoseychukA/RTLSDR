 ...
 * Коэффициенты FIR.
  *
  * Фильтр работает на частоте Xtal. Это симметричный фильтр с 32
  * коэффициенты. Указаны только первые 16 коэффициентов, остальные 16
  * используйте те же значения, но в обратном порядке. Первый коэффициент в
  * массив — внешний, последний, последний — внутренний.
  * Первые 8 коэффициентов представляют собой 8-битные целые числа со знаком, следующие 8 коэффициентов
  * — 12-битные целые числа со знаком. Все коэффициенты имеют одинаковый вес.
  *
  * Коэффициенты FIR по умолчанию, используемые для DAB/FM драйвером Windows,
  * драйвер DVB использует разные
 */
