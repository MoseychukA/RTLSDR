...
int r82xx_set_freq(struct r82xx_priv *priv, uint32_t freq)
{
  ...
  /* переключение между входами «Cable1» и «Air-In» на стиках с помощью
     Тюнер R828D. Переключаемся на частоте 345 МГц, потому что именно там
     минимальный уровень шума имеет примерно одинаковый уровень с идентичным МШУ
     настройки. Оригинальный драйвер использовал 320 МГц. */
