...
#define TOUCH_MIN_RAW_X 2100
#define TOUCH_MAX_RAW_X 30200
#define TOUCH_MIN_RAW_Y 1260
#define TOUCH_MAX_RAW_Y 31450
...
//#define TOUCH_MIN_RAW_Y 2400
//#define TOUCH_MAX_RAW_Y 26240
...
//	HAL_UART_Transmit(&huart1, (uint8_t*)buf, strlen(buf), 100);
    ...
    *y = (avg_y - TOUCH_MIN_RAW_Y) * TOUCH_SCALE_Y / (TOUCH_MAX_RAW_Y - TOUCH_MIN_RAW_Y);
	  ...
	  *x = TOUCH_SCALE_X - *x;  // если инверсия экрана
////	
//	
//	*x = avg_x;
//	*y = avg_y;
