 ...
 */ 
  ...
  void DrawThreshold(int startX, int startY, int columnsCount, int columnWidth, int startYold, RGBColor gridColor)
  {
      ...
      dc->drawLine(startX, startYold, startX + columnWidth * columnsCount, startYold, TFT_BLACK);

       dc->drawLine(startX, startY, startX + columnWidth * columnsCount, startY, color565);
