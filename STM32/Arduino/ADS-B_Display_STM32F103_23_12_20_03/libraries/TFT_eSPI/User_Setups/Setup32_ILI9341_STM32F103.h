...
#define TFT_CS   PA8 // Chip select control pin to TFT CS
#define TFT_DC   PC14 // Data Command control pin to TFT DC (may be labelled RS = Register Select)
#define TFT_RST  PC13 // Reset pin to TFT RST (or RESET)

//#define TFT_RST  -1   // Set TFT_RST to -1 if the display RESET is connected to processor reset
                        // Use an Arduino pin for initial testing as connecting to processor reset
                        // may not work (due to variations in display design)

#define TOUCH_CS PB12 // Connect to T_CS (Touch controller chip select) if XPT2046 is connected to SPI bus
