...
GPIO_TypeDef* BUTTON_PORT[BUTTONn] = {KEY0_GPIO_Port, 
                                      KEY1_GPIO_Port}; 

const uint16_t BUTTON_PIN[BUTTONn] = {KEY0_Pin, 
                                      KEY1_Pin}; 

const uint16_t BUTTON_IRQn[BUTTONn] = {KEY0_Pin_EXTI_IRQn, 
                                       KEY1_Pin_EXTI_IRQn};
