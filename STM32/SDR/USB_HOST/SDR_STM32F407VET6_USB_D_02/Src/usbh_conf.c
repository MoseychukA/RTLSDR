...
USBH_SpeedTypeDef USBH_LL_GetSpeed(USBH_HandleTypeDef *phost)
{
  ...
  case 0 :
    speed = USBH_SPEED_HIGH;
	 USBH_UsrLog("speed = USBH_SPEED_HIGH 60MB/sec");
    break;

  case 1 :
    speed = USBH_SPEED_FULL;
	 USBH_UsrLog("speed = USBH_SPEED_FULL 1.5MB/sec");
    break;

  case 2 :
    speed = USBH_SPEED_LOW;
	 USBH_UsrLog("speed = USBH_SPEED_LOW .1875MB/sec");
    break;

  default:
   speed = USBH_SPEED_FULL;
	USBH_UsrLog("default speed = USBH_SPEED_FULL 1.5MB/sec");
    break;
  }
