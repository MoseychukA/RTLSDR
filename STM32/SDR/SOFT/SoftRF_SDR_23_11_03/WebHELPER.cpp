...
<p>Author: <b>Aleksandr Moseychuk</b></p>\
...
<input type='radio' name='no_track' value='1' %s>On\
  ...
  snprintf_P(offset, size,
      PSTR("\
<tr>\
<th align=left>Alarm&nbsp;attention(2000-3000m)</th>\
<td align=right>\
...
settings->alarm_warning);
  ...
  snprintf_P(offset, size,
      PSTR("\
<tr>\
<th align=left>Alarm&nbsp;danger(10-500m)</th>\
<td align=right>\
...
<tr><th align=left>Alarm.attention</th><td align=right>%d</td></tr>\
